...
class AnFuelpriceEnv(EnvBase):
    ...
    def _step(self, tensordict: TensorDictBase) -> TensorDictBase:
        ...
        if ("agents", "data") in output_tensordict.keys(include_nested=True): # Added include_nested=True
             print(f"  Nested ('agents', 'data') keys: {output_tensordict.get(('agents', 'data')).keys(include_nested=True)}") # Added include_nested=True
             print(f"  Nested ('agents', 'data') shape: {output_tensordict.get(('agents', 'data')).shape}")
    ...
    def _get_state_at(self, data_indices: torch.Tensor) -> TensorDict:
        ...
        # Reshape node_features_reshaped to match the original batch shape
